...
#
@unittest.skipIf(os.getenv("HBNB_TYPE_STORAGE") == "db", "basemodel test not supported")
    ...
    def test_todict(self):
        ...
        if os.getenv("HBNB_TYPE_STORAGE") != "db":
            self.assertDictEqual(
                ...
                {"__class__": mdl.__class__.__name__, "id": "u-b34", "age": 13},
            )
            self.assertDictEqual(
                self.value(id="u-b34", age=None).to_dict(),
                {"__class__": mdl.__class__.__name__, "id": "u-b34", "age": None},
            )
        ...
        self.assertNotEqual(mdl_d.to_dict()["__class__"], mdl_d.__class__)
